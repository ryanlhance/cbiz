#!/usr/bin/env python3
"""Generates data.json for the CBIZ fit-map page.
...
evidence = {
  ...
  "ev-client-years": {"title": "13 Years of Client-Facing Delivery", "text": "My career began with 6 years leading client work in film and TV + advertising and music videos. Since then, 7 years of client implementation, consulting, and stakeholder management across startups, nationwide franchises, Delta Air Lines, and Bayer."},
  ...
  "ev-travel": {"title": "Happy to Travel", "text": "Would love to. Once a month on the road interests me."},
  "ev-blueprinting": {"title": "Service Blueprinting", "years": "7+ years experience", "text": "Built service blueprints at every scale from a 450-point blueprint for a startup's information architecture and executive decision making to a 20,000+ point global, enterprise level blueprint to identify service, product, technology, and operational gaps and opportunities at Bayer."},
  ...
  "ev-servant-leadership": {"title": "Servant Leadership", "years": "14+ years experience", "text": "Seven summers on staff at a summer camp serving thousands of kids, leadership development practice for high school and college students, and currently, cohort based men's work. Plus the Presidential Service Award for volunteering in my community and multiple times volunteering to lead groups through war torn countries."},
...
def jd_prose():
    return [
      {"type": "p", "segments": [
        ph("p-more-than-title", "If you are looking for more than another AI title",
           ["ev-agentic-ops", "ev-architect-operator", "ev-adoption", "pf-full"]),
        ", this opportunity provides ",
        ph("p-exec-priorities", "direct access to executive priorities",
           ["ev-exec-alignment", "ev-strategic-advising", "ev-storytelling"]),
        ", ",
        ph("p-client-impact", "meaningful client impact",
           ["ev-client-delivery", "ev-engagement-ownership", "ev-metrics"]),
        ", and ",
        ph("p-market-leader", "the chance to help establish CBIZ as a market leader in the future of AI-driven professional services",
           ["ev-ai-product", "ev-ai-agents", "ev-gtm", "pf-ai-roadmap"]),
        ".",
      ]},
      {"type": "p", "segments": [
        ph("p-readiness", "The Change and Adoption Lead is responsible for driving organizational readiness, user adoption, and sustainable change",
           ["ev-change", "ev-adoption", "ev-workforce", "pf-genai-playbook"]),
        ". This role ",
        ph("p-change-strategies", "develops and executes change strategies, stakeholder engagement plans, communications, and adoption activities",
           ["ev-change", "ev-playbooks", "ev-global-ai-training", "ev-writing"]),
        " ",
        ph("p-embrace-ai", "that help teams and clients successfully embrace new AI-enabled processes, tools, and ways of working",
           ["ev-adoption", "ev-agentic-ops", "ev-digital-tech-enablement", "ev-psych"]),
        ".",
      ]},
      {"type": "h2", "text": "Essential Functions and Primary Duties"},
      {"type": "li", "segments": [
        ph("p-ef-strategies", "Develop and lead change management and adoption strategies for AI engagements",
           ["ev-change", "ev-adoption", "ev-agentic-ops", "pf-genai-playbook"]),
        ", including ",
        ph("p-ef-stakeholder-comms", "stakeholder engagement, communication, and training support",
           ["ev-global-ai-training", "ev-training-design", "ev-curriculum", "pf-prompt-engineering"]),
        ".",
      ]},
      {"type": "li", "segments": [
        ph("p-ef-partner", "Partner with business leaders, project teams, and peer functions",
           ["ev-xfn", "ev-exec-alignment", "ev-cross-discipline"]),
        " to ",
        ph("p-ef-barriers", "assess readiness and address barriers to adoption",
           ["ev-adoption", "ev-research", "ev-psych", "ev-systems-thinking"]),
        ".",
      ]},
      {"type": "li", "segments": [
        ph("p-ef-coordinate", "Coordinate cross-functional activities",
           ["ev-xfn", "ev-concurrent", "ev-operating-cadences"]),
        " to support ",
        ph("p-ef-transitions", "smooth transitions from design through implementation and sustainment",
           ["ev-architect-operator", "ev-engagement-ownership", "ev-startup-os", "ev-playbooks"]),
        ".",
      ]},
      {"type": "li", "segments": [
        ph("p-ef-policies", "Recommend and document policies, procedures, and change practices",
           ["ev-playbooks", "ev-writing", "ev-pm-system", "pf-platform-playbook"]),
        " that ",
        ph("p-ef-effectiveness", "improve organizational effectiveness",
           ["ev-process-opt", "ev-org-restructuring", "ev-resource-reduction", "pf-eraf"]),
        ".",
      ]},
      {"type": "li", "segments": [
        ph("p-ef-sdlc", "Support project planning and execution using Traditional and Agile SDLC methodologies",
           ["ev-pm-roadmap", "ev-agile", "ev-concurrent"]),
        " and ",
        ph("p-ef-collab-tools", "collaboration tools such as VSTS and Jira",
           ["ev-tooling", "ev-pm-tools", "ev-pm-system"]),
        ".",
      ]},
      {"type": "li", "segments": [
        ph("p-ef-monitor", "Monitor adoption outcomes",
           ["ev-metrics", "ev-adoption", "pf-genai-playbook"]),
        ", ",
        ph("p-ef-corrective", "identify improvement opportunities, and recommend corrective actions where needed",
           ["ev-process-opt", "ev-root-cause", "ev-early-risk", "ev-prioritization"]),
        ".",
      ]},
      {"type": "li", "segments": [
        ph("p-ef-communicate", "Communicate effectively with stakeholders at all organizational levels",
           ["ev-speaking", "ev-writing", "ev-cross-discipline", "ev-global"]),
        " to ",
        ph("p-ef-commitment", "build understanding, commitment, and alignment",
           ["ev-exec-alignment", "ev-psych", "ev-facilitation", "ev-storytelling"]),
        ".",
      ]},
      {"type": "h2", "text": "Preferred Qualifications"},
      {"type": "li", "segments": [
        ph("p-pq-leading-change", "Experience leading organizational change, communications, training, or adoption initiatives",
           ["ev-change", "ev-workforce", "ev-training-design", "ev-curriculum"]),
        " for ",
        ph("p-pq-transformations", "digital or AI transformations",
           ["ev-adoption", "ev-agentic-ops", "ev-digital-tech-enablement", "pf-genai-playbook"]),
        ".",
      ]},
      {"type": "li", "segments": [
        ph("p-pq-frameworks", "Knowledge of change management frameworks",
           ["ev-change", "ev-decision-frameworks", "ev-psych"]),
        ", ",
        ph("p-pq-readiness", "user readiness assessment, and stakeholder engagement strategies",
           ["ev-research", "ev-prioritization", "ev-exec-alignment", "ev-facilitation"]),
        ".",
      ]},
      {"type": "li", "segments": [
        ph("p-pq-exec-comms", "Experience developing executive communications",
           ["ev-storytelling", "ev-exec-alignment", "ev-speaking"]),
        ", ",
        ph("p-pq-training-metrics", "training materials, and adoption metrics",
           ["ev-curriculum", "ev-training-design", "ev-metrics", "pf-genai-playbook"]),
        ".",
      ]},
      {"type": "li", "segments": [
        ph("p-pq-responsible-ai", "Familiarity with responsible AI considerations",
           ["ev-responsible-ai", "ev-ai-reliability", "ev-ai-tool-eval", "pf-personas"]),
        " and ",
        ph("p-pq-people-impact", "the people impact of emerging technology adoption",
           ["ev-psych", "ev-adoption", "ev-change", "ev-mission"]),
        ".",
      ]},
      {"type": "li", "segments": [
        ph("p-pq-certifications", "Relevant certifications in project management, change management, or organizational development preferred",
           ["ev-credentials", "ev-coaching", "ev-psych", "ev-ma"]),
        ".",
      ]},
      {"type": "li", "segments": [
        ph("p-pq-regulated", "Experience supporting change efforts in regulated or healthcare-related environments preferred",
           ["ev-regulatory", "ev-change", "ev-org-restructuring", "pf-journey"]),
        ".",
      ]},
      {"type": "h2", "text": "Minimum Qualifications"},
      {"type": "li", "segments": [
        ph("p-mq-bachelors", "Bachelor’s degree or equivalent experience required",
           ["ev-ma", "ev-credentials"]),
      ]},
      {"type": "li", "segments": [
        ph("p-mq-years", "At least 6 years of related experience required",
           ["ev-change", "ev-client-years", "ev-service-design", "ev-wide-industry"]),
      ]},
      {"type": "li", "segments": [
        ph("p-mq-supervisory", "Minimum 3 years of supervisory experience required",
           ["ev-hiring", "ev-startup-os", "ev-talent-dev", "ev-mentorship"]),
      ]},
      {"type": "li", "segments": [
      ...
      {"type": "li", "segments": [
        ph("p-mq-healthcare", "Demonstrated knowledge of healthcare industry regulations, policies, and procedures",
           ["ev-regulatory", "ev-org-restructuring", "ev-rapid-domain", "pf-journey"]),
      ]},
      {"type": "li", "segments": [
        ph("p-mq-stakeholders", "Demonstrated knowledge and experience working with business stakeholders and leaders",
           ["ev-exec-alignment", "ev-xfn", "ev-strategic-advising"]),
        ", ",
        ph("p-mq-it-delivery", "IT project planning, delivery, and execution using Traditional and Agile SDLC methodologies",
           ["ev-pm-roadmap", "ev-agile", "ev-concurrent", "ev-pm-system"]),
      ]},
      {"type": "li", "segments": [
        ph("p-mq-collab-tools", "Experience with VSTS, Jira, and/or other team/project collaboration tools",
           ["ev-tooling", "ev-pm-tools", "ev-pm-system", "ev-tool-migration"]),
      ]},
      {"type": "li", "segments": [
        ph("p-mq-lead-team", "Ability to work in and lead a team",
           ["ev-xfn", "ev-talent-dev", "ev-team-retention", "ev-servant-leadership"]),
        ", while ",
        ph("p-mq-peer-teams", "communicating and coordinating with peer teams",
           ["ev-xfn", "ev-cross-discipline", "ev-operating-cadences"]),
      ]},
      {"type": "li", "segments": [
        ph("p-mq-policies", "Ability to formulate, document and recommend new policies and procedures",
           ["ev-playbooks", "ev-writing", "ev-pm-system", "ev-process-opt"]),
      ]},
      {"type": "li", "segments": [
        ph("p-mq-communicate", "Demonstrated ability to communicate verbally and in writing throughout all levels of an organization",
           ["ev-speaking", "ev-writing", "ev-storytelling"]),
        ", ",
        ph("p-mq-internal-external", "both internally and externally",
           ["ev-client-delivery", "ev-exec-alignment", "ev-cross-discipline"]),
      ]},
      {"type": "li", "segments": [
        ph("p-mq-travel", "Ability to travel as required by business",
           ["ev-travel", "ev-concurrent", "ev-engagement-ownership"]),
        " and ",
        ph("p-mq-oncall", "on-call availability",
           ["ev-high-stakes-env", "ev-high-stakes-decisions", "ev-parallel", "ev-early-risk"]),
      ]},
      {"type": "li", "segments": [
        ph("p-mq-lift", "Ability to lift up to 50lbs",
           ["ev-live-events", "ev-startup-os", "ev-high-stakes-env"]),
      ]},
    ]
...
data = {
  ...
  "roles": [
    {
      "id": "change-and-adoption-lead",
      "tab_label": "Change and Adoption Lead | Artificial Intelligence",
      "job": {
        "company": "CBIZ",
        "role": "Change and Adoption Lead | Artificial Intelligence",
        "employment": "",
        "location": "1899 L Street, NW, Ste 850, Washington, DC, 20036, US (Remote) · Full time",
        "url": "https://ebez.fa.us2.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_1/job/5862",
        ...
        "candidate_lede": ("These are selected notes and resume points from Ryan Hance's career "
                           "experience mapped to the actual CBIZ job description."),
