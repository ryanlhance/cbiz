...
def jd_prose():
    return [
      {"type": "p", "segments": [
        ...
        ph("p-more-than-title", "more than another AI title",
           ["ev-agentic-ops", "ev-architect-operator", "ev-adoption", "pf-full"]),
        ", this opportunity provides direct access to executive priorities, meaningful client impact, and the chance to ",
        ph("p-market-leader", "help establish CBIZ as a market leader in the future of AI-driven professional services",
           ["ev-ai-product", "ev-ai-agents", "ev-gtm", "pf-ai-roadmap"]),
        ".",
      ]},
      {"type": "p", "segments": [
        "The Change and Adoption Lead is responsible for driving ",
        ph("p-readiness", "organizational readiness, user adoption, and sustainable change",
           ["ev-change", "ev-adoption", "ev-workforce", "pf-genai-playbook"]),
        ". This role develops and executes ",
        ph("p-change-strategies", "change strategies, stakeholder engagement plans, communications, and adoption activities",
           ["ev-change", "ev-playbooks", "ev-global-ai-training", "ev-writing"]),
        " that help teams and clients successfully embrace new AI-enabled processes, tools, and ways of working.",
      ]},
      {"type": "h2", "text": "Essential Functions and Primary Duties"},
      {"type": "li", "segments": [
        "Develop and lead ",
        ph("p-ef-strategies", "change management and adoption strategies for AI engagements",
      ...
      {"type": "li", "segments": [
        "Partner with business leaders, project teams, and peer functions to ",
        ph("p-ef-barriers", "assess readiness and address barriers to adoption",
           ["ev-adoption", "ev-research", "ev-psych", "ev-systems-thinking"]),
        ".",
      ]},
      {"type": "li", "segments": [
        "Coordinate cross-functional activities to support ",
        ph("p-ef-transitions", "smooth transitions from design through implementation and sustainment",
           ["ev-architect-operator", "ev-engagement-ownership", "ev-xfn", "ev-playbooks"]),
        ".",
      ]},
      {"type": "li", "segments": [
        "Recommend and document ",
        ph("p-ef-policies", "policies, procedures, and change practices",
      ...
      {"type": "li", "segments": [
        "Support project planning and execution using ",
        ph("p-ef-sdlc", "Traditional and Agile SDLC methodologies",
      ...
      {"type": "li", "segments": [
        ...
        ph("p-ef-corrective", "recommend corrective actions",
           ["ev-process-opt", "ev-root-cause", "ev-early-risk"]),
        " where needed.",
      ]},
      {"type": "li", "segments": [
        "Communicate effectively with ",
        ph("p-ef-communicate", "stakeholders at all organizational levels",
           ["ev-speaking", "ev-writing", "ev-cross-discipline", "ev-global"]),
        " to build ",
        ph("p-ef-commitment", "understanding, commitment, and alignment",
           ["ev-exec-alignment", "ev-psych", "ev-facilitation"]),
        ".",
      ]},
      {"type": "h2", "text": "Preferred Qualifications"},
      {"type": "li", "segments": [
        "Experience leading ",
        ph("p-pq-leading-change", "organizational change, communications, training, or adoption initiatives",
      ...
      {"type": "li", "segments": [
        "Knowledge of ",
        ph("p-pq-frameworks", "change management frameworks",
      ...
      {"type": "li", "segments": [
        ...
        ph("p-pq-exec-comms", "executive communications",
      ...
      {"type": "li", "segments": [
        "Familiarity with ",
        ph("p-pq-responsible-ai", "responsible AI considerations",
      ...
      {"type": "li", "segments": [
        "Relevant ",
        ph("p-pq-certifications", "certifications in project management, change management, or organizational development",
           ["ev-credentials", "ev-coaching", "ev-psych", "ev-ma"]),
        " preferred.",
      ]},
      {"type": "li", "segments": [
        "Experience supporting ",
        ph("p-pq-regulated", "change efforts in regulated or healthcare-related environments",
           ["ev-regulatory", "ev-change", "ev-org-restructuring", "pf-journey"]),
        " preferred.",
      ]},
      {"type": "h2", "text": "Minimum Qualifications"},
      {"type": "li", "segments": [
        ph("p-mq-bachelors", "Bachelor’s degree or equivalent experience",
           ["ev-ma", "ev-credentials"]),
        " required",
      ]},
      {"type": "li", "segments": [
        ph("p-mq-years", "At least 6 years of related experience",
           ["ev-change", "ev-client-years", "ev-service-design", "ev-wide-industry"]),
        " required",
      ]},
      {"type": "li", "segments": [
        "Minimum ",
        ph("p-mq-supervisory", "3 years of supervisory experience",
      ...
      {"type": "li", "segments": [
        ...
        ph("p-mq-healthcare", "healthcare industry regulations, policies, and procedures",
           ["ev-regulatory", "ev-org-restructuring", "ev-rapid-domain", "pf-journey"]),
      ]},
      {"type": "li", "segments": [
        "Demonstrated knowledge and experience working with ",
        ph("p-mq-stakeholders", "business stakeholders and leaders",
           ["ev-exec-alignment", "ev-xfn", "ev-strategic-advising"]),
        ", ",
        ph("p-mq-it-delivery", "IT project planning, delivery, and execution",
           ["ev-pm-roadmap", "ev-agile", "ev-concurrent", "ev-pm-system"]),
        " using Traditional and Agile SDLC methodologies",
      ]},
      {"type": "li", "segments": [
        "Experience with ",
        ph("p-mq-collab-tools", "VSTS, Jira, and/or other team/project collaboration tools",
           ["ev-tooling", "ev-pm-tools", "ev-pm-system", "ev-tool-migration"]),
      ]},
      {"type": "li", "segments": [
        "Ability to ",
        ph("p-mq-lead-team", "work in and lead a team",
           ["ev-xfn", "ev-talent-dev", "ev-team-retention", "ev-servant-leadership"]),
        ", while communicating and ",
        ph("p-mq-peer-teams", "coordinating with peer teams",
           ["ev-xfn", "ev-cross-discipline", "ev-operating-cadences"]),
      ]},
      {"type": "li", "segments": [
        "Ability to ",
        ph("p-mq-policies", "formulate, document and recommend new policies and procedures",
           ["ev-playbooks", "ev-writing", "ev-pm-system", "ev-process-opt"]),
      ]},
      {"type": "li", "segments": [
        "Demonstrated ability to ",
        ph("p-mq-communicate", "communicate verbally and in writing throughout all levels of an organization",
           ["ev-speaking", "ev-writing", "ev-storytelling", "ev-cross-discipline"]),
        ", both internally and externally",
      ]},
      {"type": "li", "segments": [
        "Ability to ",
        ph("p-mq-travel", "travel as required by business",
